...
const AWARD_IMAGE_URL = 'https://qcmkvxym51.ufs.sh/f/dwov31m0cIp82UZKkVuje8HKUVFmQABviX9nuTsJazGrcdLg';
    ...
    <div className="relative z-10">
      ...
      <section className="relative min-h-[70svh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center py-12">
          <img src={LOGO_URL} alt="CEO Media" className="h-28 sm:h-36 md:h-44 lg:h-52 w-auto mx-auto mb-4 rounded-2xl animate-float" style={{ animationDelay: '0.1s' }} />
      ...
      <section className="py-12 sm:py-20 border-t border-gold-glow relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[rgba(201,168,76,0.05)] via-transparent to-[rgba(232,212,139,0.05)]" />
        ...
        <div className="relative container mx-auto px-4 sm:px-6">
          <div className="reveal flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-4xl mx-auto">
            <div className="w-44 sm:w-52 md:w-56 shrink-0 flex items-center justify-center">
              <img src={FRESH_IMAGE_URL} alt="After Hours podcast" className="w-full h-auto max-h-44 sm:max-h-48 md:max-h-56 object-contain rounded-full drop-shadow-[0_0_20px_rgba(201,168,76,0.3)]" />
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 max-w-6xl mx-auto">
            {EPISODES.map((ep, i) => (
              <a
                key={ep.guest}
                href={ep.url}
                className="reveal hover-lift group relative rounded-2xl overflow-hidden border border-gold-glow bg-[#0D0D0F] hover:shadow-[0_0_25px_rgba(201,168,76,0.15)] transition-all duration-500 hover:border-[rgba(201,168,76,0.4)]"
              ...
              >
                ...
                <div className="p-3 sm:p-4">
                  <p className="text-[#C9A84C] text-xs font-semibold uppercase tracking-widest mb-1">{ep.guest}</p>
      ...
      <section className="py-12 sm:py-20 border-t border-gold-glow bg-[#0A0A0A]/50 relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6">
          <div className="reveal flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-4xl mx-auto">
            ...
            <div className="w-44 sm:w-52 md:w-56 shrink-0 flex items-center justify-center">
              <img src={LOGO_URL} alt="After Hours" className="w-full h-auto max-h-56 object-contain drop-shadow-[0_0_20px_rgba(201,168,76,0.3)] rounded-2xl" />
            </div>
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                <button onClick={() => window.location.href = '/apply'} className="btn-outline-gold inline-flex items-center justify-center gap-2 px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg border-2 border-[#C9A84C] text-white rounded-xl font-bold uppercase tracking-wider hover:bg-[rgba(201,168,76,0.1)] transition-all duration-300">
                  PARTNER WITH US
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                </button>
                <button onClick={() => window.location.href = '/apply'} className="btn-gold inline-flex items-center justify-center gap-2 px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg">
      ...
      <section className="py-12 sm:py-16 border-t border-gold-glow">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="reveal max-w-2xl mx-auto">
            <img src={AWARD_IMAGE_URL} alt="After Hours Podcast Achievement" className="w-full h-auto object-cover rounded-2xl" />
          </div>
        </div>
      </section>
      ...
      <footer className="py-10 border-t border-gold-glow">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-6">
            <a href="#" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-[rgba(201,168,76,0.2)] text-sm text-white hover:border-[rgba(201,168,76,0.5)] transition-all duration-300">
